...
<head>
    <title>ESP32 Fab Farm Irrigation</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <script>
        function submitMessage() {
            alert("Saved value to esp32 File System (Spiffs)");
            setTimeout(function() {
...
<body>
    ...
    <p><b>Vegie Garden (relay 1) Timer (Hours & Minutes):</b></p>
    ...
    <p><b>Cypress Hill (relay 2) (Hours & Minutes):</b></p>
    <form action="/get" target="hidden-form">
    ...
    <p><b>Fruit Trees (relay 3) (Hours & Minutes):</b></p>
    <form action="/get" target="hidden-form">
